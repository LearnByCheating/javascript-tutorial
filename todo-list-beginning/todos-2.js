/* eslint-disable prefer-destructuring, no-shadow, object-curly-newline */
...
const seedTodos = () => {
  const todos = [
    {
      id: 1, task: 'Create To Do list using an object literal', details: 'After completing the Beginning JavaScript tutorial do the To Do list project. Refer to the tutorial for reference.', done: true,
    },
    {
